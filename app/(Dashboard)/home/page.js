    ...
    return (
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto px-6 py-12">
          <h1 className="text-4xl font-bold text-center text-gray-900 mb-6">Welcome to the MIT Power Systems Lab Portal</h1>
          <p className="text-lg text-center text-gray-700 mb-12">
            This platform is dedicated to MIT professors, PhD students, and lab members for managing projects, tasks, equipment, and educational resources.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-blue-900 text-white shadow-lg">
        <div className="max-w-screen-xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <li>
            ...
            <li>
              <Link href="/reserved-equip" className="hover:text-gray-300">Equipment</Link>
            </li>
            <li>
              <Link href="/resources" className="hover:text-gray-300">Upload video</Link>
            </li>
            <li>
              <Link href="/lab-resources" className="hover:text-gray-300">Lab resources</Link>
            </li>
          </ul>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-center text-gray-900 mb-6">
          Welcome to the IIT Power Systems Lab Portal
        </h1>
        <p className="text-lg text-center text-gray-700 mb-12">
          This platform is dedicated to IIT professors, PhD students, and lab members for managing projects, tasks, equipment, and educational resources.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Manage Equipment</h3>
            </div>
            <p className="text-gray-700 mb-4">Reserve equipment for experiments and track lab resources effectively.</p>
            <a href="/equipments" className="text-blue-500 hover:text-blue-700">Go to Equipment</a>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
            ...
            <p className="text-gray-700 mb-4">Upload and manage educational materials like videos, slides, and notes for students.</p>
            <a href="/resources" className="text-blue-500 hover:text-blue-700">Go to Resources</a>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">File Sharing</h3>
            </div>
            <p className="text-gray-700 mb-4">Share research papers, project files, and resources securely within the lab community.</p>
            <a href="/file-sharing" className="text-blue-500 hover:text-blue-700">Go to File Sharing</a>
          </div>
        </div>
      </div>
    </div>
