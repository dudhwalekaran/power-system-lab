...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-[#0A192F] text-white p-4 flex justify-between items-center relative z-50">
      ...
      {/* Navigation Menu */}
      <nav
        className={`absolute lg:static top-full left-0 w-full lg:w-auto bg-[#1B1F3B] lg:bg-transparent p-4 lg:p-0 flex flex-col lg:flex-row items-start lg:items-center text-xl font-serif space-y-3 lg:space-y-0 lg:space-x-6 transition-transform duration-300 z-50 ${
